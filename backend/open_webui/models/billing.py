...
class SubscriptionItem(Base):
    ...
    subscription_id = Column(Text, ForeignKey("subscriptions.id", ondelete="CASCADE"), nullable=False)
...
class TransactionPayment(Base):
    ...
    id = Column(Text, primary_key=True, index=True, default=lambda: str(uuid.uuid4()))
    transaction_id = Column(Text, ForeignKey("transactions.id", ondelete="CASCADE"), nullable=False)
